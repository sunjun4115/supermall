<template>
    <tab-bar>
     <tab-bar-item path='/home' activeColor='#FAA7B7'>
     ...
     <tab-bar-item path='/category' activeColor='#FAA7B7'>
     ...
     <tab-bar-item path='/cat' activeColor='#FAA7B7'>
     ...
     <tab-bar-item path='/profile' activeColor='#FAA7B7'>
